...
function buildProductsDisplay($products) {
    ...
    foreach ($products as $product) {
        $pd .= '<li>';
        $pd .= "<a href='/acme/products/?action=product&invId=" . urlencode($product['invId']) . " ' title = 'View $product[invName]'> <img src='$product[invThumbnail]' alt='Image of $product[invName] on Acme.com'></a>";
        $pd .= "<a href='/acme/products/?action=product&invId=" . urlencode($product['invId']) . " ' title = 'View $product[invName]'> <h2>$product[invName]</h2></a>";
...
//    $fd = '<section>';
//    $fd .="<h2>$products[invName]</h2>";
//    $fd .="<p>$products[invDescription]</p>";
//    $fd .="<img src ='$products[invImage]' alt='Image of $products[invName] on Acme.com'>";
//    $fd .='</section>';
//    return $fd;
//
//}